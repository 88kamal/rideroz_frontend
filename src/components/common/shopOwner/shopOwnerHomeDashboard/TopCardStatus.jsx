...
const SkeletonCard = () => (
    <div className="p-1 xl:p-2 xl:w-1/5 lg:w-1/2 md:w-1/2 w-1/2">
        <div className="h-full rounded-lg overflow-hidden bg-green-50 border border-green-400">
            <div className="py-5 text-black animate-pulse">
                <div className="flex justify-center mb-3">
                    <div className="w-11 h-11 bg-green-200 rounded-full"></div>
                </div>
                <div className="h-6 w-1/3 bg-green-200 rounded mx-auto mb-2"></div>
                <div className="h-4 w-1/2 bg-green-200 rounded mx-auto"></div>
            </div>
        </div>
    </div>
);
                    ...
                    <div className="flex flex-wrap -m-1 xl:-m-2.5 mb-2 xl:mb-1">
                        {isLoading
                            ...
                            : cardsData.map((card, index) => (
                                <motion.div
                                    key={card.id}
                                    className={`p-1 xl:p-2 ${card.id === 5
                                            ? "xl:w-1/5 lg:w-full md:w-full w-full"
                                            : "xl:w-1/5 lg:w-1/2 md:w-1/2 w-1/2"
                                        } outline-none cursor-pointer`}
                                    initial={{ opacity: 0, y: 50 }}
