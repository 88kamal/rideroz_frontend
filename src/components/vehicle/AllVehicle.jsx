...
// // // const AllVehicle = () => {
// // //     const navigate = useNavigate();
// // //     const [maxDistance, setMaxDistance] = useState(100); // Initial max distance
// // //     const { lat, lng, vehicleType, vehicleCity, selectedCity, currentLocationName } = useContext(myContext);
// // //     const { data: vehicles, error, isLoading, refetch } = useGetVehiclesNearbyQuery({
// // //         lat,
// // //         lng,
...
// // //     useEffect(() => {
// // //         if (vehicles?.vehicles?.length < 5 && maxDistance < 1000) {
// // //             // Increase maxDistance if vehicles are fewer than 5 and limit distance growth to 1000
// // //             setMaxDistance(prev => prev + 100);
// // //         }
...
// // const AllVehicle = () => {
// //     const navigate = useNavigate();
// //     const [maxDistance, setMaxDistance] = useState(1000); // Initial small max distance
// //     const { lat, lng, vehicleType, vehicleCity, selectedCity } = useContext(myContext);
// //     const { data: vehicles, error, isLoading, refetch } = useGetVehiclesNearbyQuery({
// //         lat,
// //         lng,
...
// //     // Fetch more vehicles on scroll
// //     const handleScroll = useCallback(() => {
// //         if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 500 && maxDistance < 1000) {
// //             setMaxDistance(prev => prev + 100); // Increment distance limit
// //         }
// //     }, [maxDistance]);
...
//     // Fetch more vehicles on scroll
//     const handleScroll = useCallback(() => {
//         if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 500 && maxDistance < 10000) {
