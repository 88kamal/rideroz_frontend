  ...
  return (
    <Layout>
      <div className=" px-4 lg:px-6 py-4 lg:py-6">
        ...
        <div className=" drop-shadow bg-white">
          <h1 className=" font-bold text-xl mb-2 bg-gray-100 px-2 py-2">About Us</h1>
          ...
          <div className=" mt-3">
            <h2 className=" text-xl font-bold mb-2 bg-gray-100 px-2 py-2">Our Services          </h2>
            <div className="p-3">
          ...
          <div className="mt-3">
            <h2 className="text-xl font-bold mb-2 bg-gray-100 px-2 py-2">How It Works
            </h2>
